...
`CWT_STE3XM1_2607` · accent `#B1A57E` · v0.9.18
...
- Drag files/folders onto the terminal to paste their shell-quoted paths. URLs on screen are underlined in the accent color and open on a plain click (⌘-click works anywhere, incl. the input row).
