...
`CWT_STE3XM1_2607` · accent `#B1A57E` · v0.9.14
...
- Drag files/folders onto the terminal to paste their shell-quoted paths. Links are clickable — click a URL in output to open it (⌘-click works anywhere, incl. the input row).
